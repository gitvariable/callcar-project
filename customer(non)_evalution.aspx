<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer(non)_evalution.aspx.cs" Inherits="Register" %>
        ...
        <div id="home" class="container">
            ...
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 " >
                    <%--<textarea id="TextArea1" cols="20" rows="2" placeholder="請在這裡輸入您的寶貴建議，我們有改進服務的機會，謝謝您。"></textarea>--%>
            ...
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 " >
                    <a href="index.aspx" class="btn btn-success btn-lg">送出</a>
                <br /><br />
                </div>
            </div>
            <%--<div class="row">
