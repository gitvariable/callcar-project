<%@ Page Language="C#" AutoEventWireup="true" CodeFile="customer(non)_modifly-order.aspx.cs" Inherits="Register" %>
            ...
            <div class="row">
             ...
             &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;請輸入您的電話：
                ...
                <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
                    ConnectionString='<%$ ConnectionStrings:Network_Motorcade_Appointment_SystemConnectionString %>' 
                    SelectCommand="SELECT * FROM [Order] WHERE ([C_cellphone] = @C_cellphone) and [Dispatchtime]>=getdate() and ordercancel=0 ORDER BY [Dispatchtime]"
                    ...
                    <SelectParameters>
                        <asp:ControlParameter ControlID="TextBox1"  Name="C_cellphone" PropertyName="Text" Type="String" />
                         ...
                         <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource2" AutoGenerateColumns="False" DataKeyNames="Ordernumber" HorizontalAlign="Center" Width="660px" FooterStyle-HorizontalAlign="Center" HeaderStyle-HorizontalAlign="Center" CssClass="text-center" CellPadding="4" ForeColor="#333333" GridLines="None">
...
<FooterStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White"></FooterStyle>

<HeaderStyle HorizontalAlign="Center" BackColor="#1C5E55" Font-Bold="True" ForeColor="White"></HeaderStyle>
