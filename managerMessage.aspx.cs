...
public partial class managerMessage : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (Page.IsPostBack == false)
        {
            ...
            Application["A1"] = (string)(Session["m_name"]  + "  " + DateTime.Now.ToLongTimeString() + "  <b>==== 已進入訊息室! ====</b><br />");
    ...
    {   
        ...
        Application["A1"] = (/*"<font color=" + Session["my_color"] + ">" +*/ Session["m_name"] + "  " + DateTime.Now.ToLongTimeString() + "  說： " + TextBox1.Text + "</font><br />");
        my_Label.Append(Application["A1"]);
        Label1.Text = my_Label.ToString();
    ...
    {   //====離開聊天室====
        ...
        Application["A1"] = (/*"<font color=" + Session["my_color"] + ">" +*/ Session["m_name"] + "  " + DateTime.Now.ToLongTimeString() + " 已離開。<br /><br />");
        my_Label.Append((string)Application["A1"]);
        Label1.Text = my_Label.ToString();
        Session.Abandon();  //離開後，清除Session
        Application.UnLock();
        Response.Redirect("managerlogin.aspx");   //回到聊天室的「登入畫面」
    }
