<%@ Page Language="C#" AutoEventWireup="true" CodeFile="driver-function.aspx.cs" Inherits="Login" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    ...
    <script>
        $(document).ready(function () {
            ...
            //    //var DP = JSON.stringify(position);
            //    //currentPosition = new Array(position.coords.latitude, position.coords.longitude);
            //    $('#txtDP').val(position.coords.latitude + "," + position.coords.longitude);
    ...
    <form id="form1" runat="server">
            ...
            <nav class="navbar navbar-default navbar-fixed-top" style="background-color: #1ba1e2/*#403b3b*/; /*opacity: 0.5*/">
                ...
                <div class="collapse navbar-collapse" id="myNavbar">
                    <ul class="nav navbar-nav navbar-right nav-tabs-vertical ">
                        <li><a href="#schedule" data-toggle="tab">車隊排班</a></li>
        ...
        <div id="home" class="container">
            ...
            <div class="col-xs-12 <%--jumbotron--%> text-center">
                <span class="h2">司機功能選項</span>
            </div><br /><hr />
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 ">
                <%--<a href="driver-schedule.aspx" class="btn btn-primary btn-lg">進入車隊排班系統</a>--%>
                    <asp:LinkButton ID="btnSchedule" runat="server" CssClass="btn btn-primary btn-lg" OnClick="btnSchedule_Click">
            ...
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 ">
                <a href="driver_eventreport.aspx" class="btn btn-primary btn-lg">
            ...
            <div class="row">
                <div class="col-lg-offset-3 col-lg-6 col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6 col-xs-offset-3 col-xs-6 ">
                <a id="all" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#broadcast">
            ...
            <div class="row">
                ...
                <asp:LinkButton ID="btnExit" runat="server" CssClass="btn btn-primary btn-lg" OnClick="btnExit_Click">
